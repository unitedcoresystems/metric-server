...
## Deployment
In order to deploy metrics-server in your kubernetes master machine clone https://github.com/unitedcoresystems/metric-server.git  and run the commands below:
